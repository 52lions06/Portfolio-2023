      ...
      <section className={styles.flexContainer}>
        <div className={`${styles.manage} ${styles.box}`}>
          ...
          <p style={{ textAlign: "center" }}>
            {" "}
            In partnering with me, you&apos;ll find a commitment to
            compassionate leadership and efficient management that uplifts teams
            and exceeds goals. My approach delivers exceptional value to both
            people and products, ensuring your success is met with integrity and
            meaningful results.
          </p>
        </div>
